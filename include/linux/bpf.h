...
extern const struct bpf_func_proto bpf_task_storage_get_sleepable_uprobe_multi_proto;
extern const struct bpf_func_proto bpf_task_storage_get_sleepable_kprobe_proto;
